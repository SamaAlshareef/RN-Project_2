                ...
                <View style={styles.cardsContainer}>
                    ...
                    <View style={styles.packagesContainer}>
                        ...
                        <View style={styles.elevatedCards}>
                            ...
                            <Image style={{width:40,height:40, borderRadius:40/2,marginLeft:10, alignItems:'center'}} source={require('../images/aquatics.png')}/>
                                <View style={{flexDirection:'column',marginLeft:10}}>
                                    <Text>Aquatics</Text>                  
                                    <Text style={{fontSize:10, color:'#7c7c7c'}}>App Development</Text>
                                    <View style={{flexDirection:'row'}}>
                                         <Text style={{fontSize:10, color:'#7c7c7c'}}>Deadline </Text>
                                         <Text style={{fontSize:10, color:'#02dbdb'}}>March 10</Text>
                                         <Text style={{fontSize:10, color:'#7a85ff', marginLeft:30}}>$1000.00</Text>   
                                    </View>
                                </View>
                                <TouchableOpacity>
                            ...
                            <View style={{flexDirection:'row'}}>
                                <Image style={{width:40,height:40, borderRadius:40/2,marginLeft:10, alignItems:'center'}} source={require('../images/aquatics.png')}/>
                                    <View style={{flexDirection:'column',marginLeft:10}}>
                                        ...
                                        <View style={{flexDirection:'row'}}>
                                            <Text style={{fontSize:10, color:'#7c7c7c'}}>Deadline </Text>
                                            <Text style={{fontSize:10, color:'#02dbdb'}}>January 30</Text>
                                            <Text style={{fontSize:10, color:'#7a85ff', marginLeft:30}}>$1000.00</Text>
                                        </View>
                                    </View>
                                    <TouchableOpacity>
                        ...
                        <View style={styles.elevatedCards}>
                            <View style={{flexDirection:'row'}}>
                                <Image style={{width:40,height:40, borderRadius:40/2,marginLeft:10, alignItems:'center'}} source={require('../images/froneri.png')}/>
                                    <View style={{flexDirection:'column',marginLeft:10}}>
                                        <Text>Froneri</Text>                  
                                        <Text style={{fontSize:10, color:'#7c7c7c'}}>Web Development</Text>
                                        <View style={{flexDirection:'row'}}>
                                            <Text style={{fontSize:10, color:'#7c7c7c'}}>Deadline </Text>
                                            <Text style={{fontSize:10, color:'#02dbdb'}}>May 20</Text>
                                           <Text style={{fontSize:10, color:'#7a85ff',  marginLeft:30 }}>$1000.00</Text>                                            
                                        </View>
                                    </View>
                                    <TouchableOpacity>
